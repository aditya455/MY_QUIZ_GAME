class Question {
    ...
    this.question.html("WHICH OF THESE IS A BEST PLAYER IN  MINECRAFT ?");
    this.question.position(100,30);
    this.option1.html("1:TECNOBLADE");
    this.option1.position(150,60);
    this.option2.html("2:LIVE INSAAN");
    this.option2.position(150,100);
    this.option3.html("3:DREAM");
    this.option3.position(150,140);
    this.option4.html("4:BEAST_BOY_SHUB(BBS)");
